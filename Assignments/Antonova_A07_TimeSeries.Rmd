...
> Answer: We can reject the null hypothesis that ozone level are not changing over time at the 0.05 level. The ozone levels are changing over time (p-value= 0.0467).
