...
huc8_Nuese_sf <- huc8_sf %>% 
  filter(SUBBASIN == "Upper Neuse") 


#Create a map
mapView(huc8_Nuese_sf, col.regions = 'yellow',
                map.types = "CartoDB.Positron",
                legend = FALSE)+
  mapView(huc8_sf, alpha.regions =0.3)
...
wind_data_raw <- read.csv('https://raw.githubusercontent.com/ENV859/EnviroAtlasData/main/Wind_Energy.csv', colClass = c('HUC_12' ='factor')) %>%
...
HUC_8_join <-  merge(x = wind_data_raw,
                           y = huc8_sf, 
                           by.x = "HUC_8", 
                           by.y = "HUC_8" )
