...
gage_data <- read.table(theURL,skip = 28,header=TRUE,sep='\t') #values separated by tabs - tab delimited - that's what the \t means
...
#Rename columns to something more useful - the data retrieval package is specifying the column names
...
#the install option lets you store your API key 
...
df_electricity <- data.frame("State" = c(the_states),
